...
class MecFollower(object):
    ...
    def reset_errors(self)
        ...
        self.lost_line = False
        seff.timeLastUpdated = -1.0
        self.front_error = 0.0
        self.back_error = 0.0
        
        # reset pids
        
        self.front.clear_error()
        self.back.clear_error()
        return
    ...
    def follow(self,heading, on_x=False):
        ...
        self.reset_errors()
        self.on_x= on_x
        # Get the initial conditon
        self.heading = heading
        previous_time = time()
        # Init front_PID
        self.front.set_k_values(10,0,0.5)
        # Init back_PID
        self.back.set_k_values(10,0,1)
        # Get current heading
        self.heading = heading
        ...
        while True:
            # Assign the current states to the current heading
            self.assign_states()
    ...
    def oscillate(self, heading=0, osc_time=0.5):
        """ Oscillate sideways, increasing in amplitude until line
        ...
        # Todo: Find reasonalble constants
        osc_speed = 10
        osc_increment = 10
        ...
        self.logger.debug(
            "Post-correction angles: angles1: {}, angles2: {}".format(
            angle1,angle2))
